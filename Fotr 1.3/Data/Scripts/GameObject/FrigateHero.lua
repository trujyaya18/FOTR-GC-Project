...
function Definitions()
	...
	MinPlanAttachCost = 15000
	MaxPlanAttachCost = 0

	-- Commander hit list.
	Attack_Ability_Type_Names = { 
		"Capital", "Corvette", "Frigate",	-- Attack these types.
		"Interdictor", "AntiFrigate"  				-- Stay away from these types.
	}
	...
	Escort_Ability_Type_Names = { "SuperCapital", "Capital", "Corvette", "Frigate"}
	Escort_Ability_Weights = { 1.0, 1.0, 1.0, 1.0}

...
function mov()
	Find_First_Object("Corellian_Corvette").Move_To(Find_First_Object("Skirmish_Empire_Star_Base_1"))
	MessageBox("Moved")
end
...
function one()
	Spawn_Unit(Find_Object_Type("Rebel_Heavy_Tank_Brigade"), Find_First_Object("Generic_Power_Generator"), Find_Player("Rebel"))
end

...
---@class EawXHeroDeathTransitionPolicy : EawXTransitionPolicy
EawXHeroDeathTransitionPolicy = class()
...
function EawXHeroDeathTransitionPolicy:new(galactic_hero_killed_event, hero_type_name, transition_function)
    ---@private
...
function EawXHeroDeathTransitionPolicy:on_origin_entered(state_context)
end

---@param state_context table<string, any>
function EawXHeroDeathTransitionPolicy:should_transition(state_context)
    return self.hero_killed
end

---@param state_context table<string, any>
function EawXHeroDeathTransitionPolicy:on_transition(state_context)
    self.transition_function(state_context)
end

---@param hero_type_name string
---@param owner PlayerObject
function EawXHeroDeathTransitionPolicy:on_galactic_hero_killed(hero_type_name, owner)

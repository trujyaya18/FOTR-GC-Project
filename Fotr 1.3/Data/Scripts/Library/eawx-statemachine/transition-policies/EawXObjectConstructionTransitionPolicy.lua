...
---@class EawXObjectConstructionTransitionPolicy : EawXTransitionPolicy
EawXObjectConstructionTransitionPolicy = class()
...
function EawXObjectConstructionTransitionPolicy:new(production_finished_event, object_type_name, transition_function)
    ---@private
...
function EawXObjectConstructionTransitionPolicy:on_origin_entered(state_context)
end

---@param state_context table<string, any>
function EawXObjectConstructionTransitionPolicy:should_transition(state_context)
    return self.object_constructed
end

---@param state_context table<string, any>
function EawXObjectConstructionTransitionPolicy:on_transition(state_context)
    self.transition_function(state_context)
end

---@param planet Planet
---@param object_type_name string
function EawXObjectConstructionTransitionPolicy:on_production_finished(planet, object_type_name)

...
function MainForce_Thread()
	...
	repeat
		...
		AITarget = FindTarget(MainForce, "Desire_To_Hide_At_Location", "Tactical_Location", 0.8, 100)
		if not AITarget then
			AITarget = FindTarget(MainForce, "Desire_To_Hide_At_Location", "Tactical_Location", 0.8, 400)
		end

...
function MainForce_Thread()
	...
	if good_pad then 
		...
		if faction_name == "EMPIRE" or "REBEL" or "PENTASTAR" or "UNDERWORLD" or "EMPIREOFTHEHAND" or "ZSINJ_EMPIRE" or "ERIADU_AUTHORITY" or "GREATER_MALDROOD" or "CORPORATE_SECTOR" or "HAPES_CONSORTIUM" then
			MainForce.Build("UC_Mineral_Extractor", good_pad)				
		else

...
function Definitions()
	...
	{
		"MainForce"
		,"UC_Generic_Defense_Satellite_Laser = 0,1"
		,"UC_Generic_Defense_Satellite_Missile = 0,1"
		,"UC_Generic_Defense_Satellite_Repair = 0,1"
	}
	}
	RequiredCategories = {"SpaceStructure"}
